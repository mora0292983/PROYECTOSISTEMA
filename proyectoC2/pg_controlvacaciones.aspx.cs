...
{
	public partial class WebForm10977 : System.Web.UI.Page
	{
        ...
        SELECT 
            ...
            s.EstadoSolicitud
        FROM 
            sistemaGp8.SolicitudVacaciones s
        JOIN 
            sistemaGp8.Empleados e ON s.EmpleadoID = e.EmpleadoID";
        ...
        protected void gridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    btnGestionar.PostBackUrl = $"~/pg_aprobacionvacaciones.aspx?NombreEmpleado={nombreEmpleado}&ApellidoEmpleado={apellidoEmpleado}&CedulaEmpleado={cedulaEmpleado}&FechaInicio={fechaInicio}&FechaFin={fechaFin}";
